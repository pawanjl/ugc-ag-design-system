...
export function Topbar() {
    ...
    return (
        <header className="flex shrink-0 h-14 w-full items-center gap-3 border-b border-border bg-background/95 backdrop-blur-md px-4 md:px-6 z-20">
            ...
            >
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden lg:flex items-center gap-0.5 pointer-events-none">
                    <kbd className="flex items-center justify-center h-4 min-w-4 px-1 text-[10px] font-medium text-muted-foreground bg-muted border border-border rounded">
            ...
            <div className="flex items-center gap-2 ml-auto">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        ...
                        >
                            ...
                            {/* Notification dot */}
                            <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-full bg-primary ring-[1.5px] ring-background" />
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <div>
                            <FeedbackModal>
                                <Button disableScale={true} disableHover={true} variant="outline" size="sm" className="hidden md:inline-flex">
                                    Feedback
                                </Button>
                            </FeedbackModal>
                        </div>
                ...
                <DropdownMenu>
                        ...
                        <TooltipTrigger asChild>
                            <DropdownMenuTrigger asChild>
                                ...
                                ">
                                    ...
                                    <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-primary to-secondary p-[1.5px] shrink-0">
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={8}
                        className="w-52 bg-card border border-border text-foreground rounded-xl shadow-2xl"
                    >
                        ...
                        <DropdownMenuGroup>
                            <DropdownMenuItem className="gap-2 rounded-lg text-[13px] cursor-pointer hover:bg-accent focus:bg-accent">
