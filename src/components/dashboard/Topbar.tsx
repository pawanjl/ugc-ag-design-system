...
export function Topbar() {
    ...
    return (
        <header className="sticky top-0 z-20 flex h-14 w-full items-center gap-3 border-b border-border bg-background/95 backdrop-blur-md px-4 md:px-6">
            ...
            <div className="flex items-center gap-2 ml-auto">
                ...
                <DropdownMenu>
                        ...
                        ">
                            ...
                            <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-[#a855f7] to-[#22c55e] p-[1.5px] shrink-0">
                                <Avatar className="h-full w-full">
                                    ...
                                    <AvatarFallback className="bg-muted text-[11px] text-foreground font-medium">
                                        EC
                                    </AvatarFallback>
                                </Avatar>
                            </div>
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={8}
                        className="w-52 bg-popover border border-border text-foreground rounded-xl shadow-2xl"
                    >
